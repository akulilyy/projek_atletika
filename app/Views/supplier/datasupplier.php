                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div class="search-box d-flex align-items-center d-flex justify-content-end mb-2">
                                <form action="" method="get" class="d-flex">
                                    <input type="text" name="search" id="search" class="form-control" placeholder="Cari Supplier" style="width: 250px;" value="<?= esc($search) ?>">
                            ...
                            foreach ($supplier as $key) : ?>
                                <tr>
                                    ...
                                    <td class="text-center justify-content-between align-items-center">
                                        <a href="/supplier/edit/<?= $key['id_supplier']; ?>" class="btn btn-success">Edit</a>
