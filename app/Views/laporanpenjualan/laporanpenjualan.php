                    ...
                    <div class="show-entries-container">
                        ...
                        <div class="search-box d-flex align-items-center d-flex justify-content-end mb-2">
                            <form action="" method="get" class="d-flex">
                                <input type="text" name="search" id="search" class="form-control" placeholder="Cari Laporan" style="width: 250px;" value="<?= esc($search) ?>">
                            ...
                            foreach ($laporan as $key) : ?>
                                <tr>
                                    ...
                                    <td class="text-center justify-content-between align-items-center">
                                        <a href="/laporanpenjualan/edit/<?= $key['id_laporanpenjualan']; ?>" class="btn btn-success">Edit</a>
                                        <a href="javascript:void(0)" class="btn btn-danger" onclick="confirmDelete(<?= $key['id_laporanpenjualan']; ?>)">Hapus</a>
                                        <script>
                                            function confirmDelete(id) {
                                                swal({
                                                    ...
                                                    if (willDelete) {
                                                        window.location.href = "/laporanpenjualan/delete/" + id;
                                                    }
                                                });
                                            }
                                        </script>
